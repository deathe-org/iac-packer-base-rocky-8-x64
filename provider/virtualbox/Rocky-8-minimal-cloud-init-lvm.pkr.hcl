...
variable "build_iso_checksum" {
  type    = string
  default = "07b94e6b1a0b02604ce0948699a26f66dffd705c0459d428439cef02d5db43d36a6ae62ba494fe9eb94c83d6bb76b26bf7a310dc78d7a9c7432809fb9bc6194a"
}
...
variable "build_name" {
  type    = string
  default = "Rocky-8.8-x86_64-minimal-cloud-init-lvm-en_US"
}
